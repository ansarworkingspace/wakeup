    ...
    <div className='docMain'>
      ...
      <div className='border'>
       ...
       <div className="important">
        ...
        <ul>
           <li>1, ഇത് ഒരു ഇന്സ്ടിട്യൂഷനോ ഒരു ഇംഗ്ലീഷ് കോഴ്സൊ അല്ലാ. ഒരു കമ്മ്യൂണിറ്റി ആണ്
🤗.</li>
           <li>2, ഇതൊരു ടെലിഗ്രാം ബേസ് ചെയ്തുള്ളാ കമ്മ്യൂണിറ്റി ആണ്.ടെലെഗ്രാമിലൂടെ ആയിരിക്കും
ടോപിക്ക്സ് അയച്ചതരുന്നത് .</li>
           <li>3, ഇവടെ നിങ്ങളെ സഹായിക്കാൻ ഒരു അദ്ധ്യാപകനോ, ഗൈഡോ ഉണ്ടായിരിക്കുന്നതല്ല
⚠️.</li>
           <li>4,എനിക്ക് സംസാരിച്ചു എന്റെ ഇംഗ്ലീഷ് മികച്ചതാക്കണം എന്ന് സ്വയം കരുതുന്നവർ മാത്രം
കമ്മ്യൂണിറ്റിൽ അങ്കത്തം എടുക്കുക .</li>
           <li>5,തരുന്ന ടാസ്ക്ക് ചെയ്യാതെ ഇരിക്കിക്കുകയോ.മറ്റുള്ളവരോട് മോശമായി പെരുമാറുകയോ
ചെയ്താൽ ഉടൻ തന്നെ ഗ്രൂപ്പിൽ നിന്ന് റിമൂവ് ചെയ്യുകയും തുടർ നടപടി ഉണ്ടായിരിക്കുന്നതും ആണ്
.</li>


<li>6,ആദ്യത്തെ ഒരു മാസം സബ്സ്ക്രിപ്ഷൻ സൗജന്നമായിരിക്കും. പിന്നീട് അങ്ങോട്ട് തുടരണമെങ്കിൽ
പ്ലാനുകൾ എടുക്കണം .</li>
<li>7, പിന്നീട് ഉള്ള ഒരു മാസത്തേക്ക് 49 rs , മൂന്ന് മാസത്തേക്ക് ആണെകിൽ 99 rs ആണ്
😊.</li>
<li>8, ഒരുമാസം നിങ്ങൾക്ക് സൗജന്യമായി നൽകുന്നത് ഉപയോഗപ്പെടുത്തു . ഉപയോകപെട്ടാൽ ഒപ്പം
കൂടു .</li>
        </ul>
       </div>
...
നിങളുടെ മാറ്റങ്ങൾ തിരിച്ചറിയും )</li>
           ...
           <li>2,Daily Debate Audio Task Topics
